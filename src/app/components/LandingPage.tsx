      ...
      <section className="flex items-center gap-20">
        <article className="w-1/2 text-2xl tracking-wide">
          ...
          <p>
            ...
            completing tasks like homework, room cleanup, or helping around the
            house, children earn valuable tokens they can redeem for what they
            love most: extra gaming time, choice movies, or even pushing bedtime
            back a bit. It&apos;s not just about getting things done – it&apos;s
            about teaching the value of earning privileges while making the
            journey fun and engaging for the whole family.
          </p>
          <button
